...
import Animations from '../src/props.animations'
import Sizes from '../src/props.sizes'
import * as Colors from '../src/props.colors'
import * as ColorsHSL from '../src/props.colors-hsl'
import Fonts from '../src/props.fonts'
import Borders from '../src/props.borders'
import Aspects from '../src/props.aspects'
import Easings from '../src/props.easing'
import Gradients from '../src/props.gradients'
import Shadows from '../src/props.shadows'
import SVG from '../src/props.svg'
import Zindex from '../src/props.zindex'
import MaskEdges from '../src/props.masks.edges'
import MaskCornerCuts from '../src/props.masks.corner-cuts'

import {buildPropsStylesheet} from './to-stylesheet'
import {toTokens} from './to-tokens'
import {toFigmaTokens} from './to-figmatokens'
