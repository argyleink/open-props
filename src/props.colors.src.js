const openColor = (
  await import("https://cdn.skypack.dev/open-color/open-color.js")
).default;
const Color = (await import("https://colorjs.io/dist/color.esm.js")).default;

const colors = Object.entries(openColor.theme.colors).filter(
  (group) => typeof group[1] === "object"
);

const customizeIncrements = (num) =>
  num === "50" ? num.replaceAll("50", "0") : num.replaceAll("0", "");
