...
const highlightProperty = (slider) => {
  ...
  slider.connectedProperty =
    slider.parentElement.parentElement.querySelectorAll(`code > .property`)[
      offset
    ];
...
sliders.forEach((slider) => {
  ...
  slider.addEventListener("input", (e) => {
    ...
    slider.parentElement.querySelector(".sample-text").style[
      slider.dataset.prop
    ] = `var(--font-${slider.name}-${value})`;
